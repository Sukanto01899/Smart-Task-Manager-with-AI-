...
export default function Home() {
  return (
    <div className="flex flex-col gap-8 justify-center items-center w-full h-screen">
      <span className="h-6 w-6 md:h-12 md:w-12 rounded-full bg-blue-600 animate-pulse ring-2 ring-blue-400 flex justify-center items-center text-xl"><RiGeminiFill/></span>
      <h1 className="text-2xl text-blue-500 font-bold uppercase">Smart Task Manager with AI</h1>
