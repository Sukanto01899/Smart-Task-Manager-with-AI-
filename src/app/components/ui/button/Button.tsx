...
const buttonVariants = {
    ...
    ai: "bg-gradient-to-r hover:bg-gradient-to-l from-blue-500 to-blue-300 py-1 px-2 rounded-lg gap-2",
    lg: "w-full bg-blue-500 py-2 rounded-lg text-lg hover:bg-blue-400 transition-all duration-500",
    md: "",
}
