...
const Dashboard = () => {
  ...
  return (
    <div className="lg:ml-[300px] p-4 flex-1 overflow-y-auto">
      <div className="flex overflow-hidden justify-between items-center bg-blue-500 w-full h-12 rounded-lg">
        <div className="flex h-full">
          {filterOptionsList.map((option, i) => (
            <div
              ...
              } cursor-pointer w-full h-full px-5 flex items-center capitalize`}
            >
              {option}
            </div>
          ))}
